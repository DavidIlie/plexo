...
const getGenreDistributionCached = async () => {
   "use cache: remote";
   cacheLife("metadata");
...
const getTopWatchedGenresCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
...
const getMediaTypeRatioCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
...
const getHighlightsCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
...
const getDeviceStatsCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
...
const getVideoQualityStatsCached = async () => {
   "use cache: remote";
   cacheLife("metadata");
...
const getAudioFormatStatsCached = async () => {
   "use cache: remote";
   cacheLife("metadata");
...
const getMusicAudioFormatStatsCached = async () => {
   "use cache: remote";
   cacheLife("metadata");
...
const getMusicGenreDistributionCached = async () => {
   "use cache: remote";
   cacheLife("metadata");
...
const getTopArtistsCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
...
const getLibrarySizeStatsCached = async () => {
   "use cache: remote";
   cacheLife("library");
...
const getLocationStatsCached = async () => {
   "use cache: remote";
   cacheLife("analytics");
